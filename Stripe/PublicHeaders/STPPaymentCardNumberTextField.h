//
//  STPPaymentCardNumberTextField.h
//  Stripe
//
...
@class STPPaymentCardNumberTextField, STPPaymentMethodCardParams;
@protocol STPPaymentCardNumberTextFieldDelegate;

/**
 STPPaymentCardNumberTextField is a text field with similar properties to UITextField,
 ...
 */
IB_DESIGNABLE
@interface STPPaymentCardNumberTextField : UIControl <UIKeyInput>

/**
 @see STPPaymentCardNumberTextFieldDelegate
 */
@property (nonatomic, weak, nullable) IBOutlet id<STPPaymentCardNumberTextFieldDelegate> delegate;
 ...
 */
@protocol STPPaymentCardNumberTextFieldDelegate <NSObject>
@optional
/**
 ...
 - (void)paymentCardTextFieldDidChange:(STPPaymentCardNumberTextField *)textField {
    self.paymentButton.enabled = textField.isValid;
 }

 @param textField the text field that has changed
 */
- (void)paymentCardTextFieldDidChange:(nonnull STPPaymentCardNumberTextField *)textField;
 ...
 */
- (void)paymentCardTextFieldDidBeginEditing:(nonnull STPPaymentCardNumberTextField *)textField;

/**
 Notification that the user pressed the `return` key after completely filling
 out the STPPaymentCardNumberTextField with data that passes validation.

 The Stripe SDK is going to `resignFirstResponder` on the `STPPaymentCardNumberTextField`
 ...
 @param textField The STPPaymentCardNumberTextField that was being edited when the user pressed return
 */
- (void)paymentCardTextFieldWillEndEditingForReturn:(nonnull STPPaymentCardNumberTextField *)textField;
 ...
 */
- (void)paymentCardTextFieldDidEndEditing:(nonnull STPPaymentCardNumberTextField *)textField;

/**
 Called when editing begins in the payment card field's number field.
 */
- (void)paymentCardTextFieldDidBeginEditingNumber:(nonnull STPPaymentCardNumberTextField *)textField;

/**
 Called when editing ends in the payment card field's number field.
 */
- (void)paymentCardTextFieldDidEndEditingNumber:(nonnull STPPaymentCardNumberTextField *)textField;

/**
 Called when editing begins in the payment card field's CVC field.
 */
- (void)paymentCardTextFieldDidBeginEditingCVC:(nonnull STPPaymentCardNumberTextField *)textField;

/**
 Called when editing ends in the payment card field's CVC field.
 */
- (void)paymentCardTextFieldDidEndEditingCVC:(nonnull STPPaymentCardNumberTextField *)textField;

/**
 Called when editing begins in the payment card field's expiration field.
 */
- (void)paymentCardTextFieldDidBeginEditingExpiration:(nonnull STPPaymentCardNumberTextField *)textField;

/**
 Called when editing ends in the payment card field's expiration field.
 */
- (void)paymentCardTextFieldDidEndEditingExpiration:(nonnull STPPaymentCardNumberTextField *)textField;

/**
 Called when editing begins in the payment card field's ZIP/postal code field.
 */
- (void)paymentCardTextFieldDidBeginEditingPostalCode:(nonnull STPPaymentCardNumberTextField *)textField;

/**
 Called when editing ends in the payment card field's ZIP/postal code field.
 */
- (void)paymentCardTextFieldDidEndEditingPostalCode:(nonnull STPPaymentCardNumberTextField *)textField;
@end
